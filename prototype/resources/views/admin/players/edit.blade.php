                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    @if($player->image)
                                        <div class="shrink-0 group relative">
                                            <img src="{{ asset('storage/' . $player->image) }}" alt="Preview"
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                            @foreach($groupTeams as $team)
                                                <label
                                                    class="flex items-center gap-x-3 p-3 rounded-lg border border-slate-200 hover:bg-slate-50 cursor-pointer transition-colors has-[:checked]:bg-indigo-50 has-[:checked]:border-indigo-200">
